      ...
      <section className="features-section">
        ...
        <motion.div className="features-grid" variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }}>
          <motion.div className="feature-card" variants={fade}>
            ...
            <p>
              Real-time health score calculated from 21 sensor parameters using
              advanced ensemble ML models. Get per-parameter breakdowns and
          ...
          <motion.div className="feature-card" variants={fade}>
            ...
            <p>
              Predict disease risk with 99.8% model accuracy. Identify threats
              like powdery mildew, botrytis, and root rot before visible
              symptoms appear, with specific warnings.
            </p>
          </motion.div>
          ...
          <motion.div className="feature-card" variants={fade}>
            ...
            <p>
              ...
              climate data, and crop-specific models. Know exactly when
              and how much to irrigate with 97% F1-score accuracy.
            </p>
          </motion.div>
        </motion.div>
